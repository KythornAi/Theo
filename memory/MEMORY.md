...
§
Tools: DeepSeek default; Codex for reasoning/code; Claude for writing; agy for multimodal. TinyFish→Perplexity→Firecrawl. No browser screenshots, no git add -A.
§
